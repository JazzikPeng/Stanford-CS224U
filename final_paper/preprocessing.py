"""
Preprocess PPDB dataset. Extract paraphrase pairs and relations 
from ppdb-2.0-s-phrasal
"""
...
def main():
    ...
    arg_parser.add_argument('--min_len', type=int, required=False, default=0)
